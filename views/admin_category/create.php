            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <input type="text" name="sort_order" placeholder="" value="<?php echo $options['sort_order'];?>">

                        <p>Статус</p>
                        <select name="status">
                            <option value="1" <?php if ($options['status'] == 1) echo ' selected="selected"'; ?>>Отображается</option>
                            <option value="0" <?php if ($options['status'] == 0) echo ' selected="selected"'; ?>>Скрыта</option>
                        </select>
